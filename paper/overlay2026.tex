...
(Anthropic) in order to: draft and paraphrase prose, perform
grammar and spelling checks, support structural editing, and
assist with the Lean source code of the accompanying
implementation.  After using this tool, the authors reviewed
